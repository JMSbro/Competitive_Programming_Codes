...
void solve(){
    ...
    // if(a == b) cout << 0 << endl;
    // else if(mx == mn + 1) cout << 1 << endl;
    // else if(x > mx && x > mn ) cout << 2 << endl;
    // else{
    //     ll ans = 0;
    //     ans = mx- mn;
    //     ll cnt = 0;
    ...
    //         mx /= x;
    //         cnt++;
    //         ans = min(ans, cnt + (max(mx, mn) - min(mx, mn)));
    //         while(mn > mx){
                
    //         }
    //     }
        // ll tmp = mx, old = mx, nw = -1, cnt = 0;
        // //dbg(tmp);
        // while(1){
        //     old = tmp;
        //     nw = tmp / x;

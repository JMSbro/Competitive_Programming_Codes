...
void solve(){
    ...
    ll abc = d / lcm(a, lcm(b,c)) ;
    ll ab = d / lcm(a, b), bc = d / lcm(b, c), ac = d / lcm(c, a);
    ll ad = d/a, bd = d/b, cd = d/c;

    ll aw, bw  ,cw; 
    aw = ad * 6  - (ab * 3) - (ac * 3) + (abc * 2);
    bw = bd * 6  - (ab * 3) - (bc * 3) + (abc * 2);
    cw = cd * 6  - (bc * 3) - (ac * 3) + (abc * 2);
